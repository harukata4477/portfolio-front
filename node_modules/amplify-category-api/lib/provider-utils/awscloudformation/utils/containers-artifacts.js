...
exports.processDockerConfig = exports.generateContainersArtifacts = void 0;
...
async function generateContainersArtifacts(context, resource, askForExposedContainer = false) {
    ...
    amplify_cli_core_1.JSONUtilities.writeJson(path.normalize(path.join(resourceDir, cfnFileName)), cfn);
    return {
        exposedContainer,

...
exports.MappingTemplate = exports.InlineTemplate = exports.S3MappingTemplate = void 0;
...
class S3MappingTemplate {
    ...
    bind(scope) {
        if (!this.asset) {
            this.asset = new file_asset_1.FileAsset(scope, `Template${this.name}`, {

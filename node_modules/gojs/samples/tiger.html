...
';
    ...
    function init() {
      ...
      var tigerdrawing = new go.Panel();  // this Panel holds all of the Shapes for the drawing
      ...
      for (var i = 0; i < paths.length; i++) {
        ...
        tigerdrawing.add(shape);
      }

      // add the Panel as the only element in the Part
      var tigerpart = new go.Part();  // doesn't need to be a Node for this sample
...
<div id="sample">
  <b>An SVG drawing converted into a GoJS Part with many Shapes</b>
  <div id="myDiagramDiv" style="border: solid 1px black; width:99%; height:920px"></div>
</div>
    </div>
    <!-- * * * * * * * * * * * * * -->

  ...
  <div class="text-white bg-nwoods-primary">
    ...
    <div class="container max-w-screen-lg px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
      ...
      <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
        ...
        <div class="mx-auto">
          <a class="rounded inline-block mx-auto lg:mr-0 lg:ml-4  text-gray-800 hover:text-white hover:bg-nwoods-secondary bg-white font-bold my-6 p-4 shadow-lg"
  ...
  <section class="bg-white border-b pb-8 text-gray-800">
    <div class="container max-w-5xl mx-auto mb-8">
      ...
      <div class="p-6 flex-wrap flex-col-reverse sm:flex-row">
        ...
        <p>
          GoJS offers a number of features for
          interactivity such as drag-and-drop, copy-and-paste, in-place text editing,
          tooltips, context menus, automatic layouts, templates,
          data binding and models, transactional state and undo management,
          extensible tools for custom operations, and more.
        </p>
      </div>
      ...
      <div class="grid grid-cols-2 md:grid-cols-4">
        ...
        <div class="p-2">
            <a href="./samples/flowchart.html"><img class="border" src="assets/images/site1.png" alt="Flowchart" >
            <h3>Flowcharts</h3></a>
        ...
        <div class="p-2">
          <a href="./samples/stateChart.html"><img class="border" src="assets/images/site6.png" alt="State Chart" />
        ...
        <div class="p-2">
          <a href="./samples/sankey.html"><img class="border" src="assets/images/site2.png" alt="Sankey Diagram" />
        ...
        <div class="p-2">
          <a href="./samples/genogram.html"><img class="border" src="assets/images/site5.png" alt="Leaflet Map" />
          <h3>Genogram Diagrams</h3></a>
          <div>Create Genogram and Medical diagrams, or editable family trees with collapsible levels.</div>
        </div>
        <div class="p-2">
          <a href="./samples/orgChartEditor.html"><img class="border" src="assets/images/site3.png" alt="Org Chart" />
          <h3>Org Charts</h3></a>
          <div>Create classic org charts for viewing or editing. Automatic layouts make different visualization options easy.</div>
        </div>
        <div class="p-2">
          <a href="./samples/dynamicPorts.html"><img class="border" src="assets/images/site7.png" alt="Dynamic Ports Demo" />
        ...
        <div class="p-2">
          <a href="./samples/productionProcess.html"><img class="border" src="assets/images/site4.png" alt="Data Visualization" />
        ...
        <div class="p-2">
          <a href="./samples/regrouping.html"><img class="border" src="assets/images/site8.png" alt="Regrouping Demo" />
        ...
        <div class="max-w-screen-lg xl:max-w-screen-xl mx-auto divide-y divide-gray-200 px-4 sm:px-6 md:px-8">
          <ul class="text-sm font-medium pb-14 sm:pb-20 grid grid-cols-1 sm:grid-cols-3 gap-y-10">
            ...
            <li class="list-none row-span-2">
              ...
              <ul class="list-none space-y-4 md:space-y-1 px-0">
                <li>
                  <a href="https://www.nwoods.com/contact.html" onclick="ga('send','event','Outbound Link','click','contact');">Contact</a>
                </li>
                <li>
                ...
                <li>
                  <a href="https://www.nwoods.com/sales/index.html" onclick="ga('send','event','Outbound Link','click','buy');">Buy</a>
                </li>
                <li>

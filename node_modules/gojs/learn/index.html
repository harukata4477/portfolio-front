...
<!-- Copyright 1998-2021 by Northwoods Software Corporation. -->    <title> Get Started with GoJS </title>
  ...
  <a href="../learn/interactivity.html">GoJS Interactivity</a>
      </nav>
    </div>      
...
<p>
  ...
  you will need to make sure that your page declares that it is an HTML5
  document. And of course you need to load the library:
</p>
...
<p>
  ...
  <a target="_blank" href="../download.html">here</a>. Alternatively you can
  link straight to a <b>GoJS</b> library provided by a
  <a
    target="_blank"
...
<p>Together, this creates an empty diagram:</p>
...
<p>
  ...
  <code>go.GraphObject.make</code> to build <b>GoJS</b> objects. For more
  detail, read
  <a href="../intro/buildingObjects.html">Building Objects in GoJS</a>. Using
  <code>$</code> as an abbreviation for <code>go.GraphObject.make</code> is so
  handy that we will assume its use from now on. If you use <code>$</code> for
  something else in your code, you can always pick a different short variable
  name, such as <code>$$</code> or <code>MAKE</code> or <code>GO</code>.
</p>
...
<ul>
  ...
  <li>
    Use CTRL-C and CTRL-V, or control-drag-and-drop, to make a copy of the
    selection.
  </li>
  <li>
...
<p>
  ...
  GraphObject is <em>not</em> an HTML DOM element, so much less overhead in
...
<p>
  <b>GoJS</b> has several other layouts, which you can read about
...
<script>
  var $ = go.GraphObject.make;
  var myDiagram = $(go.Diagram, "myDiagramDiv5", {
    "undoManager.isEnabled": true,
    layout: $(
...
<script>
  var $ = go.GraphObject.make;
  var myDiagram = $(go.Diagram, "myDiagramDiv6", {

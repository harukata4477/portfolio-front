...
<!-- Copyright 1998-2021 by Northwoods Software Corporation. -->    <title> GoJS Data Binding -- Northwoods Software </title>
...
<pre class="lang-js" id="bindTwoWay"><code>
  ...
  window.shiftNode = (function() {  // define a function named "shiftNode" callable by button.onclick
    // all model changes should happen in a transaction

...
<!-- Copyright 1998-2021 by Northwoods Software Corporation. -->    <title> GoJS Sizing of GraphObjects -- Northwoods Software </title>
...
<pre class="lang-js" id="shapeSizes"><code>
  diagram.add(
    $(go.Part,
      $(go.Panel, "Table",
...
<pre class="lang-js" id="sizedShapes"><code>
...
<pre class="lang-js" id="stretchSizes"><code>
  diagram.add(
    $(go.Part,
      $(go.Panel, "Table",
        { defaultAlignment: go.Spot.Left },
...
<pre class="lang-js" id="shapeAlignment"><code>
  diagram.add(
    $(go.Part,
      $(go.Panel, "Table",
        { defaultAlignment: go.Spot.Left },
...
<pre class="lang-js" id="bigShapeAlignment"><code>
  diagram.add(
    $(go.Part,
      $(go.Panel, "Table",
        { defaultAlignment: go.Spot.Left },

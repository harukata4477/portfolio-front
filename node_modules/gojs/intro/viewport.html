...
<!-- Copyright 1998-2021 by Northwoods Software Corporation. -->    <title> GoJS Coordinate Systems-- Northwoods Software </title>
...
<pre class="lang-js" id="diffCoordSystems" style="display:none"><code>
...
<pre class="lang-js" id="coordsystems"><code>
...
<pre class="lang-js" id="scrollmargin" style="display: none;"><code>
...
<pre class="lang-js" id="scrollmodes" style="display: none;"><code>
...
<pre class="lang-js" id="nestedpanelcoords" style="display: none;"><code>
  // read-only to avoid accidentally moving any Part in document coordinates
  diagram.isReadOnly = true;

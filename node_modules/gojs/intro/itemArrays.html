...
<!-- Copyright 1998-2021 by Northwoods Software Corporation. -->    <title> GoJS Item Arrays-- Northwoods Software </title>
...
<pre class="lang-js" id="vertical"><code>
  diagram.nodeTemplate =
    $(go.Node, "Auto",
...
<pre class="lang-js" id="verticalobjects"><code>
  diagram.nodeTemplate =
    $(go.Node, "Auto",
      $(go.Shape, "RoundedRectangle",
        { fill: "#3AA7A3" }),
...
<pre class="lang-js" id="horizontal"><code>
  diagram.nodeTemplate =
    $(go.Node, "Auto",
      $(go.Shape, "RoundedRectangle",
        { fill: "gold" }),
...
<pre class="lang-js" id="table"><code>
  diagram.nodeTemplate =
    $(go.Node, "Auto",
...
<pre class="lang-js" id="alternating"><code>
  diagram.nodeTemplate =
    $(go.Node, "Auto",
      $(go.Shape, { fill: "white" }),
      $(go.Panel, "Table",

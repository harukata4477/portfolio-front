...
<!-- Copyright 1998-2021 by Northwoods Software Corporation. -->    <title> GoJS Building GraphObjects -- Northwoods Software </title>
...
<pre class="lang-js" id="simpleJSAML"><code>
...
<pre class="lang-js" id="simpleJSAML2"><code>
  var $ = go.GraphObject.make;
  diagram.add(
    $(go.Node, "Auto",
...
<pre class="lang-js" id="gradientJSAML"><code>
  diagram.add(
    $(go.Node, "Auto",
      $(go.Shape, "RoundedRectangle",

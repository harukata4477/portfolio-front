...
<!-- Copyright 1998-2021 by Northwoods Software Corporation. -->    <title> GoJS Using Models -- Northwoods Software </title>
...
<pre class="lang-js" id="twoNodesOneLinkCode"><code>
  var node1 =
    $(go.Node, "Auto",
      $(go.Shape,
...
<pre class="lang-js" id="simpleModelNoTemplates"><code>
  var nodeDataArray = [
    { key: "Alpha"},
    { key: "Beta" }
  ];
...
<pre class="lang-js" id="simpleModelNoBind"><code>
...
<pre class="lang-js" id="simpleTree"><code>
  diagram.nodeTemplate =
    $(go.Node, "Auto",
      $(go.Shape,
        { figure: "Ellipse" },

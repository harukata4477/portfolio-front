...
<!-- Copyright 1998-2021 by Northwoods Software Corporation. -->    <title> GoJS User Permissions -- Northwoods Software </title>
...
<pre class="lang-js" id="isEnabled"><code>
...
<pre class="lang-js" id="isReadOnly"><code>
  diagram.commandHandler.archetypeGroupData =
    { key: "Group", isGroup: true, color: "blue" };
...
<pre class="lang-js" id="isModelReadOnly"><code>
  diagram.commandHandler.archetypeGroupData =
    { key: "Group", isGroup: true, color: "blue" };

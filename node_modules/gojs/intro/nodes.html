...
<!-- Copyright 1998-2021 by Northwoods Software Corporation. -->    <title> GoJS Nodes -- Northwoods Software </title>
...
<pre class="lang-js" id="border"><code>
...
<pre class="lang-js" id="shapes"><code>
  diagram.nodeTemplate =
    $(go.Node, "Auto",
      $(go.Shape,
...
<pre class="lang-js" id="borderedtable"><code>
  diagram.nodeTemplate =
    $(go.Node, "Auto",
      $(go.Shape,
...
<pre class="lang-js" id="fixedsize2"><code>
  diagram.nodeTemplate =
    $(go.Node, "Auto",
      $(go.Shape,
...
<pre class="lang-js" id="icons"><code>
  diagram.nodeTemplate =
    $(go.Node, "Vertical",
      $(go.Picture,
...
<pre class="lang-js" id="icons2"><code>
  diagram.nodeTemplate =
    $(go.Node, "Vertical",
      $(go.TextBlock,
        { margin: new go.Margin(3, 0, 0, 0),
...
<pre class="lang-js" id="smallicons"><code>
  diagram.nodeTemplate =
    $(go.Node, "Horizontal",
      $(go.Picture,
...
<pre class="lang-js" id="nestedpanel1"><code>
...
<pre class="lang-js" id="spotdecorations"><code>
  diagram.nodeTemplate =
    $(go.Node, "Spot",
      // the main content:
      $(go.Panel, "Vertical",
...
<pre class="lang-js" id="ribbondecorations"><code>
  diagram.nodeTemplate =
    $(go.Node, "Spot",
...
<pre class="lang-js" id="positionlocation"><code>
...
<pre class="lang-js" id="positionlocation2"><code>
diagram.grid.visible = true;

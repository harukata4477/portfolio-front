...
<!-- Copyright 1998-2021 by Northwoods Software Corporation. -->    <title> GoJS Debugging Suggestions-- Northwoods Software </title>
...
<div id="container" class="container-fluid">
  <div id="content">
    ...
    <p>
      ...
      <pre class="lang-js"><code>myDiagram = $(go.Diagram, "myDiagramDiv", . . .);</code></pre>
    </p>
    <p>
    ...
    <p>
      <pre class="lang-js"><code>myDiagram.nodes.size</code></pre>
      returns the number of <a>Node</a>s in the Diagram.
    </p>
    <p>
      <pre class="lang-js"><code>myDiagram.model.nodeDataArray[0]</code></pre>
      returns the first node data object in the diagram's model's <a>Model.nodeDataArray</a>.
    </p>
    <p>
      <pre class="lang-js"><code>myDiagram.layoutDiagram(true)</code></pre>
    ...
    <p>
      ...
      <pre class="lang-js">><code> myNode = myDiagram.findNodeForKey("Omega");
> myNode.isSelected = true
> myDiagram.commandHandler.scrollToPart(myNode)</code></pre>
    ...
    <p>
      ...
      <pre class="lang-js">><code> myNode = myDiagram.selection.first()
> myNode.data.key</code></pre>
      remembers the first selected Node and returns the key of the node data.
      You might want to look at all of the properties of the <pre class="lang-js"><code>myNode.data</code></pre> object.
    </p>
    <p>
      You could also look at other properties of the Node and call its methods.  For example:
      <pre class="lang-js"><code>myNode.location</code></pre>
      returns a <a>Point</a> whose properties the debugger may show.  Or call:
      <pre class="lang-js"><code>myNode.location.toString()</code></pre>
    ...
    <p>
      ...
      <pre class="lang-js"><code>myNode.findNodesOutOf().each(function(n) { console.log(n.data.key); })</code></pre>

...
<!-- Copyright 1998-2021 by Northwoods Software Corporation. -->    <title> GoJS Tools -- Northwoods Software </title>
...
<p>While each prebuilt tool in GoJS is used for a different purpose, all Tools are guaranteed to share some functions and properties.
  ...
  representing the general lifecycle of a tool.
                                                                          <pre class="lang-js" id="toolLifecycle" style="display: none"><code>
...
<pre class="lang-js" id="resizing"><code>
  diagram.add(
    $(go.Node, "Auto",
      { resizable: true },
...
<pre class="lang-js" id="resizingObject"><code>
  diagram.add(
    $(go.Node, "Vertical",
...
<pre class="lang-js" id="resizingMaxMin"><code>
  diagram.add(
    $(go.Node, "Vertical",
...
<pre class="lang-js" id="resizingCellSize"><code>
  diagram.add(
    $(go.Node, "Vertical",
      { resizable: true, resizeObjectName: "SHAPE",
...
<pre class="lang-js" id="resizingObjectBinding"><code>
  diagram.add(
    $(go.Node, "Vertical",
      { resizable: true, resizeObjectName: "SHAPE",
        selectionObjectName: "SHAPE" },
...
<pre class="lang-js" id="resizingTemplate"><code>
  diagram.add(
    $(go.Node, "Vertical",
      { resizable: true, resizeObjectName: "SHAPE",
...
<pre class="lang-js" id="rotating"><code>
  diagram.add(
    $(go.Node, "Auto",
...
<pre class="lang-js" id="rotatingObject"><code>
  diagram.add(
    $(go.Node, "Vertical",
...
<pre class="lang-js" id="rotatingObjectBinding"><code>
  diagram.add(
    $(go.Node, "Vertical",
...
<pre class="lang-js" id="rotatingToolAngle"><code>
  diagram.add(
    $(go.Node, "Auto",
      { rotatable: true, locationSpot: go.Spot.Center },
...
<pre class="lang-js" id="rotatingTemplate"><code>
  diagram.add(
    $(go.Node, "Vertical",
      { rotatable: true, rotateObjectName: "SHAPE",
        locationSpot: go.Spot.Center, locationObjectName: "SHAPE",
...
<pre class="lang-js" id="relinking"><code>
  diagram.nodeTemplate =
    $(go.Node, "Auto",
      $(go.Shape, "Rectangle",
...
<pre class="lang-js" id="linkReshaping"><code>
  diagram.nodeTemplate =
    $(go.Node, "Auto",
...
<pre class="lang-js" id="linkResegmenting"><code>
  diagram.nodeTemplate =
    $(go.Node, "Auto",
      new go.Binding("location", "loc", go.Point.parse),
      $(go.Shape, "Rectangle", { fill: "lightgray" }),
...
<pre class="lang-js" id="dragSelecting"><code>
  diagram.nodeTemplate =
    $(go.Node, "Auto",
      new go.Binding("location", "loc", go.Point.parse),
      $(go.Shape, "Rectangle", { fill: "lightgray" }),
...
<pre class="lang-js" id="linkingTools"><code>

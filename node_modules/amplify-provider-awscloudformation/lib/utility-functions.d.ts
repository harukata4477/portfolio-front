...
export declare function upsertSecretValue(context: any, options: any): Promise<import("aws-sdk/lib/request").PromiseResult<AWS.SecretsManager.CreateSecretResponse, AWS.AWSError>>;

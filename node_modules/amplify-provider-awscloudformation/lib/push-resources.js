...
exports.generateAndUploadRootStack = exports.storeCurrentCloudBackend = exports.updateStackForAPIMigration = exports.run = void 0;
...
async function run(context, resourceDefinition) {
    ...
    try {
        ...
        const resources = !!((_a = context === null || context === void 0 ? void 0 : context.exeInfo) === null || _a === void 0 ? void 0 : _a.forcePush) ? allResources : resourcesToBeCreated.concat(resourcesToBeUpdated);
...
async function formNestedStack(context, projectDetails, categoryName, resourceName, serviceName, skipEnv) {
    ...
    const { APIGatewayAuthURL, NetworkStackS3Url } = amplifyMeta.providers[constants_1.default.ProviderName];
    if (APIGatewayAuthURL) {
        const stack = {

...
exports.createEnvLevelConstructs = void 0;
...
async function createEnvLevelConstructs(context) {
    ...
    const updatedMeta = {};
    Object.assign(updatedMeta, await createNetworkResources(context, stackName, hasContainers), consolidate_apigw_policies_1.consolidateApiGatewayPolicies(context, stackName));
...
async function createNetworkResources(context, stackName, needsVpc) {
    ...
    const { vpcId, internetGatewayId, subnetCidrs } = await environment_info_1.getEnvironmentNetworkInfo(context, {
        stackName,
        vpcName,
        vpcCidr: '10.0.0.0/16',
        subnetsCount: 3,
    ...
    await pre_push_cfn_modifier_1.prePushCfnTemplateModifier(cfn);

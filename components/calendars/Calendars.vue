    ...
    <v-col class="pt-0 pb-0 pl-0 pr-0">
      <v-sheet >
        <div class="plan_header" style="display: flex; justify-content: space-between; align-items: center; margin: 10px 0;">
          <p class="pie-graph_title" style="display: inline-block; font-weight: bold; border-bottom: solid 1px #333; margin: 10px">今日の予定</p>
...
export default {
  ...
  methods: {
    ...
    this.new_day = today
      ...
      await this.$axios.$get(`api/calendars/${today}`, {
        headers:{
